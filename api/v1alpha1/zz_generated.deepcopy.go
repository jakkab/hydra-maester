...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OAuth2ClientJSON) DeepCopyInto(out *OAuth2ClientJSON) {
	*out = *in
	if in.ClientID != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OAuth2ClientJSON.
func (in *OAuth2ClientJSON) DeepCopy() *OAuth2ClientJSON {
	if in == nil {
		return nil
	}
	out := new(OAuth2ClientJSON)
	in.DeepCopyInto(out)
	return out
}
